...
import hu.drorszagkriszaxel.semicolon.ui.fragment.QuotesFragment;
 ...
 * ---
 *
 * Adapter class to handle connection between Quotes Activity's ViewPager and Fragments
 *
 */
public class QuotePagerAdapter extends FragmentPagerAdapter {
     ...
     */
    public QuotePagerAdapter(FragmentManager fm, String[] tabNames) {
    ...
    /**
     * Forces the ViewPager to refresh fragments.
     *
     * @param object Required but not used
    ...
    public Fragment getItem(int position) {
        ...
        return QuotesFragment.newInstance(position);
