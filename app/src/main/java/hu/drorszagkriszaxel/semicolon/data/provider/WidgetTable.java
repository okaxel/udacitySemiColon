 ...
 * of the table of the widget record
 *
 */
public interface WidgetTable {

    @DataType(DataType.Type.INTEGER) @PrimaryKey @AutoIncrement String _ID = "_id";
    @DataType(DataType.Type.TEXT) @NotNull String ID = "id";
    @DataType(DataType.Type.TEXT) @NotNull String TEXT = "text";
    @DataType(DataType.Type.TEXT) @NotNull String AUTHOR = "author";
    @DataType(DataType.Type.INTEGER) @NotNull String QUOTE_STATE = "quote_state";
    @DataType(DataType.Type.INTEGER) @NotNull String CODE_STATE = "code_state";
